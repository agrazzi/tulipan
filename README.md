# TULIPAN (TUbulin LIgand Pocket ANalysis)
GROMACS-based analysis protocol for characterizing ligand binding modes on multisite proteins from unbiased molecular dynamics simulations. Implemented as a modular Bash workflow integrating GROMACS trajectory tools with Python-based fitting and post-processing utilities.
<p align="center">
  <img src="logo_TULIPAN.png" width="600">
</p>

# Introduction to TULIPAN
TULIPAN (TUbulin LIgand Pocket ANalysis) is a molecular dynamics analysis protocol for the characterization of long-lived ligand binding modes on multisite proteins. It has been developed as part of the publication "TITLE". 
# Usage
